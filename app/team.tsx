                ...
                <ScrollView contentContainerStyle={styles.content}>
                    <BlurView intensity={85} tint="dark" style={styles.panel}>
                        ...
                        {activeTeam ? (
                            <>
                                ...
                                <Text style={styles.metaText}>INVITE CODE: {activeTeam.code}</Text>
                                <Text style={styles.metaText}>MEMBERS: {activeTeam.members.length}</Text>
                    ...
                    <BlurView intensity={85} tint="dark" style={styles.panel}>
                        ...
                        <TextInput
                            ...
                            maxLength={6}
                        />
                        <TouchableOpacity style={styles.primaryBtn} onPress={joinTeamByCode}>
                            ...
                            teams.map((team) => (
                                ...
                                >
                                    <View>
                                        ...
                                        <Text style={styles.teamMeta}>CODE {team.code} | MEMBERS {team.members.length}</Text>
                                    </View>
